...
这部分最好的书我个人认为就是：《[Code](https://book.douban.com/subject/1494026/)》（中文译文《[编码的奥秘](https://book.douban.com/subject/1024570/)》）。
...
至于为啥不用刚刚「微指令」来定义流水线的“步骤”长度？还正好是一个时钟周期？嗯。。这个问题有待查阅与讨论。我的猜测是，有些运算
...
最终居然还问：**「时钟周期」「至少」**是多少？离谱的是间隔多年后又出了一遍。

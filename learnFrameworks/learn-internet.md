即：Internet Protocol suite
# Internet Protocol suite
---

[wiki of internet protocol suite](https://en.wikipedia.org/wiki/Internet_protocol_suite)

![](learn-internet.assets/OSI模型.png)

![](learn-internet.assets/v2-ec64022ca37ce5b1de17d98a3d3bbf86_1440w.jpg)
...
![](learn-internet.assets/Screen Shot 2021-10-07 at 01.10.44.png)
#### 延迟与传播速度关系不大
##### 内容提供商限制传播速率
...
![](learn-internet.assets/Electromagnetic-Spectrum.svg)
...
>
> ![](learn-internet.assets/Screen Shot 2021-10-07 at 11.22.07.png)
>
> 比如我访问微信的官网，可以看到跳转经过这些路由或服务器，最终被转发到微信官网的服务器，我大至画了网络结构图，当然肯定有不准确的地方：
>
> ![](learn-internet.assets/IMG_1843.jpeg)
>
...
![](learn-internet.assets/IMG_2056.jpeg)
...
Q：**每一跳都要重写ip数据首部的源地址和Mac桢首部的源地址、目的地址吗？那数据传回时怎么还原？且重写源IP和网络地址转换（NAT）有哪些联系和区别？**
...
![](learn-internet.assets/Screen Shot 2021-10-22 at 01.01.30.png)
...
![](learn-internet.assets/Screen Shot 2021-10-22 at 11.35.08.png)
...
![](learn-internet.assets/IMG_2099.jpeg)
...
![](learn-internet.assets/IMG_1273.jpeg)

上图几种可能出现的错误情况都没问题，但是效率的问题就来了，这样发送太慢了，我们能不能多组一起发？可以，但问题就会复杂起来，这就是所谓的流水线问题：(更像是多发射？)

![](learn-internet.assets/Screen Shot 2021-08-14 at 22.03.32.png)
这怎么确认呢？**GBN（Go-Back-N）协议**来了：

![](earn-internet.assets/Screen Shot 2021-08-14 at 22.06.30.png)

### GBN与SR
#### GBN延迟“拖累”窗口发送的情况
作为对比，这种情况与分组存储转发的平均传输速率、总时间等问题，见上文章节《平均传输速率》。

![](learn-internet.assets/IMG_1936.jpeg)
延迟是看第一个包的总延迟。
...
![](learn-internet.assets/IMG_2243.jpeg)
...
![](learn-internet.assets/IMG_2059.jpeg)
...
![](learn-internet.assets/IMG_2244.jpeg)
拥塞之后再次慢开始得策略基本已被弃用(也不完全是，因为3次ACK可能没超时，但是超时可能还是会发生)，换用下面的快恢复。
![](learn-internet.assets/IMG_2245.jpeg)
...
![](learn-internet.assets/HTTP_layers.png)
